...
const AddEventForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post('https://campus-metrics-maestro-backend.vercel.app/api/events', {
...
// eslint-disable-next-line
  ...
  return (
    ...
    >
      ...
      <Typography variant="h6" sx={{fontFamily: 'inherit'}}>Select User Type:</Typography>
      <RadioGroup row value={userType} onChange={handleUserTypeChange}>
        <FormControlLabel value="faculty" control={<Radio />} label={<Typography sx={{ fontFamily: 'cursive',fontWeight: 'bold' }}>Faculty</Typography>}/>
        <FormControlLabel value="student" control={<Radio />} label={<Typography sx={{ fontFamily: 'cursive',fontWeight: 'bold' }}>Student</Typography>}/>
      </RadioGroup>
      {userType && (
        <>
          <Typography variant="h6" sx={{fontFamily:'inherit'}}>Select Department:</Typography>
          <RadioGroup row value={selectedDepartment} onChange={handleDepartmentChange}>
            <FormControlLabel value="cse" control={<Radio />} label={<Typography sx={{ fontFamily: 'cursive',fontWeight: 'bold' }}>CSE</Typography>}/>
            <FormControlLabel value="electronics" control={<Radio />} label={<Typography sx={{ fontFamily: 'cursive',fontWeight: 'bold' }}>IT</Typography>} />
            <FormControlLabel value="electrical" control={<Radio />} label={<Typography sx={{ fontFamily: 'cursive',fontWeight: 'bold' }}>Electronics</Typography>} />
            <FormControlLabel value="it" control={<Radio />} label={<Typography sx={{ fontFamily: 'cursive',fontWeight: 'bold' }}>Electrical</Typography>} />
            <FormControlLabel value="mechanical" control={<Radio />} label={<Typography sx={{ fontFamily: 'cursive',fontWeight: 'bold' }}>Mechanical</Typography>} />
            <FormControlLabel value="civil" control={<Radio />} label={<Typography sx={{ fontFamily: 'cursive',fontWeight: 'bold' }}>Civil</Typography>} />
          </RadioGroup>
        </>
      )}
      {userType && (
  <>
    <Typography variant="h6" sx={{fontFamily:'inherit'}}>Select Activity Type:</Typography>
    <RadioGroup row value={eventType} onChange={handleEventTypeChange}>
      {userType === 'faculty' ? (
        <>
          <FormControlLabel value="achievements" control={<Radio />} label={<Typography sx={{ fontFamily: 'cursive',fontWeight: 'bold' }}>Achievements</Typography>} />
          <FormControlLabel value="publications" control={<Radio />} label={<Typography sx={{ fontFamily: 'cursive',fontWeight: 'bold' }}>Publications</Typography>} />
          <FormControlLabel value="google_scholar" control={<Radio />} label={<Typography sx={{ fontFamily: 'cursive',fontWeight: 'bold' }}>Google Scholar</Typography>} />
          <FormControlLabel value="revenue" control={<Radio />} label={<Typography sx={{ fontFamily: 'cursive',fontWeight: 'bold' }}>Revenue</Typography>} />
        </>
      ) : (
        <>
          <FormControlLabel value="exam" control={<Radio />} label={<Typography sx={{ fontFamily: 'cursive',fontWeight: 'bold' }}>Exam</Typography>} />
          <FormControlLabel value="achievements" control={<Radio />} label={<Typography sx={{ fontFamily: 'cursive',fontWeight: 'bold' }}>Achievements</Typography>} />
          <FormControlLabel value="hackathons" control={<Radio />} label={<Typography sx={{ fontFamily: 'cursive',fontWeight: 'bold' }}>Hackathons</Typography>} />
        </>
      )}
    </RadioGroup>
  ...
  onChange={handleChange}
  fullWidth
  InputLabelProps={{ shrink: true,style: { fontFamily: 'cursive' } }}
  InputProps={{ style: { fontFamily: 'cursive' } }} 
  margin="normal"
...
{userType === 'faculty' && eventType === 'google_scholar' && (
    <>
        ...
        />
          ...
          <Button variant="contained" color="primary" onClick={handleConfirm} sx={{ mt:2,fontFamily: 'cursive'}}>
            Confirm
          </Button>
        </Box>
      )}
...
<Snackbar open={submitted} autoHideDuration={6000} onClose={() => setSubmitted(false)}>
      ...
      {showConfirm && (
        <Box mt={2}>
          <Typography variant="h6" sx={{fontFamily:'cursive'}}>Please confirm your submission:</Typography>
          <Button variant="contained" color="secondary" onClick={handleSubmit} sx={{fontFamily:'cursive'}}>
            Submit
          </Button>
          <Button variant="outlined" onClick={() => setShowConfirm(false)} sx={{ ml: 2,fontFamily: 'cursive'}}>
            Cancel
          </Button>
        </Box>
      )}
