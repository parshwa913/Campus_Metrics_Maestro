...
const Login = () => {
    ...
    return (
        ...
        >
            ...
            >
                <Typography variant="h4" align="center" marginBottom={2} fontFamily={'fantasy'} sx={{ color: '#333' }}> {/*login heading*/}
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Button
                        ...
                        fullWidth
                        sx={{ mt: 2, backgroundColor: '#4A90E2', color: '#fff' ,fontFamily:''}} //login button 
                    >
                ...
                <Button
                    ...
                    fullWidth
                    sx={{ mt: 2, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '12px',fontFamily: '' }} //sign in with google button
